...
public class Moped implements Vehicle 
{
    ...
    public Moped(String mark, int modelsAmount) 
    {
        this.mark = mark;
        ...
        {
            models.add(new Model(mark + idNum, rnd.nextDouble(5, 10)));
            idNum++;
        }
    }
    ...
    {
        Moped newcar = (Moped)super.clone();
        newcar.models = new LinkedList<Model>();
